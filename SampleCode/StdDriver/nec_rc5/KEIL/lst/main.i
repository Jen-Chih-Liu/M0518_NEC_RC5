...
{
    uint32_t u32TimeOutCnt = (22118400UL);
...
void GPAB_IRQHandler(void)
{
    ...
    if (((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )))->ISRC & (0x00000020)))
    {
        ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )))->ISRC = (0x00000020));
    }
...
int32_t main(void)
{
    ...
    GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 5, 0x00000001UL);
    NVIC_EnableIRQ(GPAB_IRQn);

    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)), (1UL << 27), 5000);
